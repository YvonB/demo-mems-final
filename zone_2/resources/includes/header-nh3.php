<header>
        ...
        <div class="date_time">
          ...
          ?>
           <!-- affiche heure -->
          <script type="text/javascript" src="/js/affiche-heure.js"></script><!-- end heure -->
        </div>
          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              ...
              <ul class="nav navbar-nav navbar-right colortextnav">
                <li><a href="/home"><b><i class="fa fa-home" style="margin-right: 4px;font-size: 18px;"></i>Vers l'accueil</b><span style="text-transform: lowercase;">Retour vers l'accueil'</span></a></li>
